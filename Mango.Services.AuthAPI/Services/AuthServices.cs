...
namespace Mango.Services.AuthAPI.Services
{
    public class AuthServices : IAuthServices
    {
        ...
        public AuthServices(AppDbContext db, UserManager<ApplicationUser> userManager, RoleManager<IdentityRole> roleManager, IJwtTokenGenerator jwtTokenGenerator)
        {
            _db = db;
        ...
        async Task<bool> IAuthServices.AssignRole(string email, string roleName)
        {
